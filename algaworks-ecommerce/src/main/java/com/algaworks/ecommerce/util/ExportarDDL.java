...
//Usando nesse formato não é necessário utilizar os parametro no arquivo persistence.xml
public class ExportarDDL {
    ...
    public static void main(String[] args) {
        ...
        propriedades.put("javax.persistence.schema-generation.scripts.create-target",
                "/home/felipe/Documents/Java/JPA/script-criacao-exportado.sql");
        propriedades.put("javax.persistence.schema-generation.scripts.drop-target",
                "/home/felipe/Documents/Java/JPA/script-remocao-exportado.sql");
